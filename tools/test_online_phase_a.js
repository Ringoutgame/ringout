...
{
  ok(R.FB_ONLINE_MODE_IDS.join(',') === 'classic,speed,team2v2,lives,timedffa,tactical,tactical4',
     'das Register kennt genau die sieben vereinbarten Modi (Tactical 4-Ball 1v1 seit 2026-09-21)');
  ok(Object.keys(R.FB_ONLINE_MODES).sort().join(',') === 'classic,lives,speed,tactical,tactical4,team2v2,timedffa',
     'und keine weiteren');
...
{
  const SOLL = { classic: [2], speed: [2], team2v2: [4], lives: [3, 4, 5], timedffa: [3, 4, 5], tactical: [2], tactical4: [2] };
...
// Neue simultane Wettbewerbsmodi duerfen deshalb nicht als fertig angeboten werden.
{
  ...
  ok(R.fbModeReleased('team2v2') === true,
     'Team 2v2 ist seit 2026-09-21 online freigegeben (v11, genau vier Sitze)');
  for (const m of ['classic', 'speed', 'timedffa'])
  ...
  ok(R.fbModeSelectable('team2v2') === true, '... Team 2v2 ebenso');
  for (const m of ['classic', 'speed', 'timedffa'])
...
// ist. Die Lobby fragt jetzt den Raummodus.
{
  ...
  ok(R.fbModeReleased('team2v2') === true, 'Team 2v2 ist seit 2026-09-21 freigegeben (v11, vier Sitze)');
