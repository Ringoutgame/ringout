...
const SUITES = [
  ...
  { name: 'Online-V11-Client', file: 'test_online_v11_client.js', expectPassed: 183 },   // PLAYER LOOP V11: der Lebenszyklus des Clients - Teilnehmerliste je Generation (Luecken eingeschlossen), identitaetsgebundene Bereitschaft, atomarer Start aus gen+state+pt, Rueckweg in DIESELBE Lobby, Wiederkehr der oeffentlichen Liste. Kein Host, der startet; kein zweites Spielermodell neben der Elimination.
