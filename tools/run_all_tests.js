...
const SUITES = [
  ...
  { name: 'Football-EliteBot', file: 'test_football_elitebot.js', expectPassed: 123 },   // ELITE BOT (lokales 1v1): Verdrahtung, der Planer sieht nur oeffentlichen Zustand, verdeckte Eingaben aendern den Zug nicht, gleiche Saat -> gleicher Zug, Planung veraendert Stand/Koerper/Phase nicht, Suche ist begrenzt und in Scheiben bitgleich, Lebenslauf des Plans, Spielstaerke auf vier gestellten Lagen (echte Physik)   // TACTICAL 4-BALL EROEFFNUNG: eigene Konstante FOOTBALL_TACTICAL4_SPAWN (7.50/+-5.00, 9.40/0, 12.60/4.00) - Geometrie (neun Koerper, Spiegelung, Abstaende, Torkorridor, freie Bahnen), die alte gespiegelte Vier-Koerper-Aufstellung reproduziert den leichten Eroeffnungstreffer, die neue nicht (echte Physik, Blau == Rot), Team 2v2 und Tactical 1v1 unveraendert
];
