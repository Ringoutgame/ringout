...
const SUITES = [
  ...
  { name: 'Fixed-Timestep',  file: 'test_fixed_timestep.js', expectPassed: 204 },  // Gameplay laeuft in festen 60-Hz-Schritten, unabhaengig von der Bildwiederholrate
  ...
  { name: 'RingOut-PackageB', file: 'test_ringout_package_b.js', expectPassed: 45 },   // Package B: RingOut FFA/Triple/Team Duel v12 - typisierter Skip fuer abwesende Sitze, passiv statt ausgeschieden, hoechstens 3 Versuche, v8 und Football unveraendert
  { name: 'Sanitize',         file: 'test_sanitize.js',       expectPassed: 24 },
  { name: 'Identity',         file: 'test_identity.js',       expectPassed: 45 },
  { name: 'ValidateRoom',     file: 'test_validateroom.js',   expectPassed: 51 },
  ...
  { name: 'FFA-Online-Race',  file: 'test_ffa_race.js',       expectPassed: 115 },
        { name: 'Reconnect-B2',     file: 'test_reconnect.js',      expectPassed: 213 },   // 53 Bestand (RC1-RC11) + 14 RC-ENV + 17 RC-UID/RC-UID2: Seat-Eigentum ueber auth.uid, Diebstahlversuch mit bekannter Spieler-ID, Zweittab, Mehrdeutigkeit und Legacy-Rueckfall
          { name: 'Protokoll',        file: 'test_online_protocol.js', expectPassed: 267 },
  { name: 'Online-PhaseA',   file: 'test_online_phase_a.js', expectPassed: 423 },   // PROTOKOLL v8 PHASE A: ein Modusregister mit Sollbesetzung, Freigabetor fuer noch nicht fertige Onlinemodi, modusbewusste Lobby mit Soll/Ist - und der Nachweis, dass der Zugpfad unveraendert der v7-Pfad ist (kein v9-Mechanismus)   // reine Schema-/Vertragsschicht: Version, Raumtyp, Sitz/Koerper, kanonische Zugereignisse
  { name: 'Raum-Protokollweiche', file: 'test_online_room_protocol_routing.js', expectPassed: 86 },   // STUFE 2A: die Protokollfassung gehoert dem RAUM, nicht dem Client. Ein NEUER Raum bekommt sie aus seiner Konfiguration - Football mit der Lebensregel und drei bis fuenf Sitzen wird v9, alles andere bleibt v8, und der Waehler zieht dieselben Grenzen wie die Rules. Bestehende Raeume behalten ihre Fassung; derselbe ausgelieferte Client betritt beide Familien und ist in einem v8-Raum ausdruecklich KEIN v9-Client. Der Zugslot t bleibt v8 vorbehalten, die v9-Knoten bleiben v9-Raeumen vorbehalten - kein Mischbetrieb.
  ...
  { name: 'Public-Lobby',     file: 'test_public_lobby.js',   expectPassed: 112 },
