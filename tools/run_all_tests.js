...
const SUITES = [
  ...
  { name: 'Online-PhaseA',   file: 'test_online_phase_a.js', expectPassed: 421 },   // PROTOKOLL v8 PHASE A: ein Modusregister mit Sollbesetzung, Freigabetor fuer noch nicht fertige Onlinemodi, modusbewusste Lobby mit Soll/Ist - und der Nachweis, dass der Zugpfad unveraendert der v7-Pfad ist (kein v9-Mechanismus)   // reine Schema-/Vertragsschicht: Version, Raumtyp, Sitz/Koerper, kanonische Zugereignisse
  ...
  { name: 'Rules',            file: 'test_rules.js',          expectPassed: 764 },   // v4: Seat-Ownership, Football-Raumtyp, typisierte Zuege (move/skip/remove) und die Eviction; Package B: RingOut-v12-Skip (36)
  ...
  { name: 'Football-Namen',   file: 'test_football_names.js', expectPassed: 88 },
  { name: 'Football-Tactical-Online', file: 'test_football_tactical_online.js', expectPassed: 72 },   // TACTICAL 1V1 ONLINE: v11-Raum mit zwei Sitzen und abwechselnden Zuegen - Register/Raumfassung, Zugformel (Sitz 0 eroeffnet, jede Runde und jedes Rematch wechselt), Koerperbesitz (Sitz s: 2s/2s+1), Eingabegatter, Zugmengenpruefung und -wirkung (nur der Sitz am Zug startet), zwei Clients identisch, Namen auf beiden Figuren; die Rules dazu in test_rules.js (18)   // Namensschilder ueber den Figuren: das echte drawBall gegen einen aufzeichnenden Zeichenkontext. Zwei bis fuenf Teilnehmer bekommen genau ihre eigenen Namen, der neutrale Ball nie einen; neuer Raum/Rejoin/Sitztausch zeigen nie einen alten Namen; Ring Out bleibt Zeichen fuer Zeichen unveraendert.
