...
const SUITES = [
  ...
  { name: 'Football-Online', file: 'test_football_online.js', expectPassed: 365 },   // fuenf getrennte Clients an einer Datenbank: Lobby, paralleler Commit, gleichzeitiger Abschuss, Tore/Leben, 5->4->3->2, Rehydrierung
