...
const SUITES = [
  ...
  { name: 'Render-Recovery',  file: 'test_render_recovery.js', expectPassed: 39 },   // Shared: ein fehlgeschlagenes Bild beendet die Bildschleife nie; hoechstens 3 Wiederherstellungen je Fehlerklasse ueber den bestehenden Kontextverlust-Zyklus, dann kontrollierter Endzustand; Simulation laeuft weiter
