...
const SUITES = [
  ...
  { name: 'Online-V9',      file: 'test_online_v9.js', expectPassed: 161 },   // V9.1/V9.2 GRUNDLAGE, NUR RULES: autoritative Turn-Eroeffnung (d/<turn>/{n,o}) und Commit-Terminal (c/<turn>/<seat>) - der freigegebene Client steht weiterhin auf Protokoll 8 und kann keinen v9-Raum anlegen. dazu der Reveal-Anker (ro/<turn>) und das write-once Reveal-Ergebnis (r/<turn>/<seat>) hinter der vollstaendigen Commit-Barriere. Die Rules koennen SHA-256 NICHT rechnen - die Bindung Hash<->Reveal und jede Spielwirkung kommen erst mit V9.3.
  ...
  { name: 'Online-V9-Netz',  file: 'test_online_v9_network.js', expectPassed: 163 },   // V9.3B2A ADAPTER, RUHEND: die duenne Schicht zu Firebase - Turn eroeffnen, Commit und Reveal schreiben, vier Knoten belauschen. Geprueft gegen eine deterministische Attrappe, also OHNE Emulator, Netz oder npm-Firebase; der ergaenzende Beweis mit dem echten SDK liegt in test_online_v9_sdk.js und wird von Hand angestossen.
  { name: 'Online-V9-Ablauf', file: 'test_online_v9_coordinator.js', expectPassed: 118 },   // V9.3B2B ABLAUFSTEUERUNG, RUHEND: Runde eroeffnen, eigenes Terminal, Commit-Barriere, Reveal-Anker, eigenes Ergebnis, Ergebnisbarriere, geprüfte Zugmenge - ausdruecklich NUR der gute Fall. Keine Fristen, keine Sentinel-Schreiber, kein applyLaunch, keine Spielfolge.
