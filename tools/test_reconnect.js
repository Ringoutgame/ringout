...
const SRC = [
  ...
  // Verwalteter Game-Over-Overlay-Timer: newGame/startOnlineGame/leaveOnline/
  // onOppLeft brechen ihn ab — die ECHTE Funktion, damit der Vertrag mitlaeuft.
  ...
  grab(/async function releaseReservation\(code,seat,dc,tok\)\{[\s\S]*?\n\}/, 'releaseReservation'),
  ...
  grab(/function findOwnSeat\(players,pid,uid,hintSeat\)\{[\s\S]*?\n\}/, 'findOwnSeat'),
