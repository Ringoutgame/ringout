...
- Pruefstand: `tools/test_football_names.js` (87) fuehrt das **echte** `drawBall` gegen einen aufzeichnenden Zeichenkontext; Laufzeitbelege und Bilder in `artifacts/namen01/`.
