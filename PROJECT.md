...
- **Zweck:** technische Basis/Testharness für den späteren Online-FFA (M8-T3+, noch offen). Online-FFA ist clientseitig noch nicht aktiviert (4 Blocker); serverseitig seit M8-T3b vorbereitet (Protocol v2, Rules veröffentlicht). Testabdeckung: FFA-Logik-Suite 18/18 (Scratchpad-Harness auf echtem `stepSim`/`afterResult`).
