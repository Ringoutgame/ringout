...
vollständig reproduzierbar über `tools/sfx/build_ring_collapse_sfx.js` im RingOut-Quellrepository (Branch `feat/protocol-v4-bc`)
...
### Quellen (alle CC0; die Originaldateien liegen im RingOut-Quellrepository unter `assets/sfx/source/ring_collapse/`, nicht in dieser App)
