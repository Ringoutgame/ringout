...
- [ ] **Online-FFA 2–5 Spieler (M8-T3+):** Restschritte — **T3d:** restliche Disconnect-Matrix (v1-Verhalten steht: FFA-Leave = Elimination, 1v1/2v2-Leave = Match-Ende, Lobby-Abbrüche; offen z. B. Reconnect-Entscheidungen), **T3e:** Abnahme + Live-Smoke auf der veröffentlichten URL. Bump-Frage entschieden: Online-FFA = v2 (aktiv seit M8-T3b), M5-T2 würde später v3.
