...
- [ ] **Firebase-Konfiguration absichern:** API-Key und Datenbank-URL aus dem Quellcode entfernen. Entweder Build-System mit `.env`-Variablen einrichten oder Firebase App Check aktivieren, um unbefugten Zugriff zu verhindern.
- [ ] **Firebase Datenbankregeln härten:** Schreibzugriff auf `/rooms/` einschränken (z. B. nur valide Strukturen erlauben, Rate-Limiting).
